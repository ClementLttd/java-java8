...
public class DateAndTime_04_Test {
	...
	public void test_localDateTime_parse() {
		...
		String p = "2 mars 2009 à 09h30m00s";
		DateTimeFormatter pattern = DateTimeFormatter.ofPattern("dd' 'MM' 'yyyy' à 'HH' 'mm' 'ss");
		LocalDateTime result = LocalDateTime.parse(p, pattern);
